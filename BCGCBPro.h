...
// of the accompanying license agreement.
	...
	#include <afxtempl.h>
		...
		#error You cannot mix-up BCGControlBar Pro and MFC "Feature Pack" classes: please remove #include <afxcontrolbars.h> in your stdafx.h, make all required renames using the following grid: https://www.bcgsoft.com/doc/BCGControlBarPro_MFC_Class_Relation.htm and clean-up the application registry branch (or use a new registry path).
	#else
		#pragma message("You cannot mix-up BCGControlBar Pro and MFC \"Feature Pack\" classes: please remove #include <afxcontrolbars.h> in your stdafx.h, make all required renames using the following grid: https://www.bcgsoft.com/doc/BCGControlBarPro_MFC_Class_Relation.htm and clean-up the application registry branch (or use a new registry path).")
	#endif
#endif
...
inline BCGCBPRODLLEXPORT CFrameWnd* BCGCBProSetTopLevelFrame (CFrameWnd* pFrame)
{
	CFrameWnd* pOldValue = g_pBCGPTopLevelFrame;
...
public:
	...
	static BOOL	m_bUseBufferedPaint;
...
#ifndef bcgp_max
#define bcgp_max(a,b)	(((a) > (b)) ? (a) : (b))
#endif

#ifndef bcgp_min
#define bcgp_min(a,b)	(((a) < (b)) ? (a) : (b))
#endif
