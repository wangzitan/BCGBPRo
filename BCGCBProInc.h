...
#define _BCGCB_VERSION_(BCGP_MAJOR, BCGP_MINOR) "BCGCBPRO" #BCGP_MAJOR "" #BCGP_MINOR
#define _BCGCB_VERSION1_(BCGP_MAJOR, BCGP_MINOR) _BCGCB_VERSION_(BCGP_MAJOR, BCGP_MINOR)
#define _BCGCB_LIBNAME1_ _BCGCB_VERSION1_(_BCGCBPRO_VERSION_MAJOR, _BCGCBPRO_VERSION_MINOR)
...
#elif _MSC_VER < 2000
	#define _BCGCB_LIBNAME_	_BCGCB_LIBNAME5_##"141.lib"
#else
