...
class BCGCBPRODLLEXPORT CBCGPAppointment : public CObject
{
	...
	friend class CBCGPPlannerViewSchedule;
...
public:
	...
	enum BCGP_APPOINTMENT_HITTEST_TYPES
	{
		BCGP_APPOINTMENT_HITTEST_TYPE_VERT = 0x01,
		BCGP_APPOINTMENT_HITTEST_TYPE_HORZ = 0x02
	};
...
public:
	...
	virtual BCGP_APPOINTMENT_HITTEST HitTestEx (const CPoint& point, DWORD dwFlags) const;
...
enum BCGP_SORTAPPOINTMENTS_TYPE
{
	BCGP_SORTAPPOINTMENTS_BY_TYPE_AND_DATE = 1,
	BCGP_SORTAPPOINTMENTS_BY_DATE          = 2
};

void BCGCBPRODLLEXPORT SortAppointments (XBCGPAppointmentArray& a, int size, BCGP_SORTAPPOINTMENTS_TYPE type = BCGP_SORTAPPOINTMENTS_BY_TYPE_AND_DATE);
