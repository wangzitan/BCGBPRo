...
public:
	...
	virtual BOOL CanBeRemovedFromQAT() const
	{
		return TRUE;
	}
	...
	BOOL HasParentMenu(BOOL bCheckForAutohidePopup = FALSE) const;
...
public:
	...
	virtual void Redraw ();
	virtual void RedrawWnd(CWnd* pWnd);
	virtual void DestroyCtrl () {}

	virtual void SetAutohidePopupMode(BOOL bSet)
	{
		m_bIsAutohidePopupMode = bSet;
	}
	...
	virtual BOOL CanBeResizedInGroupVertically() const
	{
		return TRUE;
	}
...
protected:
	...
	{
		UNREFERENCED_PARAMETER(pParentMenu);
	}
