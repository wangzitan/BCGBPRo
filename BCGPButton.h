...
public:
	...
	virtual BOOL IsDefaultButton (BOOL bCheckForOtherButtonFocus = TRUE) const;
...
protected:
	...
	CBCGPMenuImages::IMAGE_STATE	m_StdImageStateHighlighted;
	CBCGPMenuImages::IMAGE_STATE	m_StdImageStatePressed;
...
public:
	...
	void SetTooltip (LPCTSTR lpszToolTipText, LPCTSTR lpszToolTipDescription = NULL);	// lpszToolTip == NULL: disable tooltip
	void GetTooltip (CString& strTooltip);
	void GetTooltipDescription (CString& strTooltipDescription);
...
protected:
	...
	afx_msg LRESULT OnBCGOnChangeUnderline(WPARAM, LPARAM);
	DECLARE_MESSAGE_MAP()
	...
	void RedrawParentDlgDefaultButton();
