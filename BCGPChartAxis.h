...
public:
	...
	void SetTitleMode(CBCGPChartTernaryAxis::TitleMode tm, BOOL bRedraw = FALSE);
	CBCGPChartTernaryAxis::TitleMode GetTitleMode() const {return m_titleMode;}
...
protected:
	...
	CBCGPChartTernaryAxis::TitleMode	m_titleMode;
};
