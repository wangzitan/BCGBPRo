...
int CBCGPChartSeriesColorTheme::GenerateColors(int nColorIndex, CBCGPBrush::BCGP_GRADIENT_TYPE type)
{
	...
	pNewColors->m_brDataLabelFillColor.MakeDarker(dblChangeRatio);
	pNewColors->m_brDataLabelFillColor.MakePale();
	pNewColors->m_brDataLabelLineColor.MakeDarker(dblChangeRatio);
	pNewColors->m_brDataLabelTextColor.MakeDarker(dblChangeRatio);
...
void CBCGPChartTheme::SetTheme(CBCGPChartTheme::ChartTheme chartTheme)
{
	...
	case CT_SPB:
		...
		InitChartColors(*this, CBCGPColor::White, RGB(98, 107, 122), RGB(96, 105, 123), RGB(186, 203, 221));
		
		InitSeriesColors(m_seriesColors[0], RGB(152, 184, 206));
		InitSeriesColors(m_seriesColors[1], RGB(210, 188, 190));
		InitSeriesColors(m_seriesColors[2], RGB(178, 167, 159));
		InitSeriesColors(m_seriesColors[3], RGB(155, 176, 182));
		InitSeriesColors(m_seriesColors[4], RGB(174, 171, 190));
		break;
		
	case CT_PALACE:
		m_bIsFlatTheme = TRUE;
		
		InitChartColors(*this, CBCGPColor::White, RGB(120, 70, 45), RGB(55, 53, 53), RGB(207, 172, 78));
		
		InitSeriesColors(m_seriesColors[0], RGB(217, 147, 122));
		InitSeriesColors(m_seriesColors[1], RGB(156, 201, 146));
		InitSeriesColors(m_seriesColors[2], RGB(124, 163, 180));
		InitSeriesColors(m_seriesColors[3], RGB(207, 172, 78));
		InitSeriesColors(m_seriesColors[4], RGB(117, 126, 131));
		break;
		
	case CT_ICE:
		m_bIsFlatTheme = TRUE;
		
		InitChartColors(*this, CBCGPColor::White, RGB(59, 87, 124), colorNull, RGB(146, 169, 229));
		
		InitSeriesColors(m_seriesColors[0], RGB(142, 170, 244));
		InitSeriesColors(m_seriesColors[1], RGB(174, 178, 214));
		InitSeriesColors(m_seriesColors[2], RGB(173, 202, 246));
		InitSeriesColors(m_seriesColors[3], RGB(116, 137, 175));
		InitSeriesColors(m_seriesColors[4], RGB(16, 164, 220));
		break;
