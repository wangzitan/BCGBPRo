...
public:
	...
	const CBCGPChartSurfaceTriangleIDArray& GetTriangleIDArray() const
	{
		return m_arTriangleID;
	}
...
public:
	...
	CBCGPBarChartImpl(CBCGPChartVisualObject* pRelatedChartControl)
		: CBCGPBaseChartImpl(pRelatedChartControl)
	{
	}
	...
	BOOL IsSeriesReversedOrder(const CBCGPChartSeries* pSeries) const;
...
protected:
	...
	BOOL _IsSeriesReversedOrder(const CBCGPChartSeries* pSeries, int nVisibleSeriesCount) const;
};
