...
struct BCGCBPRODLLEXPORT BCGPChartCellParams
{
	BCGPChartCellParams()
	{
		...
		m_textAlignment = CBCGPTextFormat::BCGP_TEXT_ALIGNMENT_CENTER;
	}
	...
	CBCGPTextFormat::BCGP_TEXT_ALIGNMENT	m_textAlignment;
...
public:
	...
	void SetTextAlignment(CBCGPTextFormat::BCGP_TEXT_ALIGNMENT textAlignment, BOOL bRedraw = TRUE);
	CBCGPTextFormat::BCGP_TEXT_ALIGNMENT GetTextAlignment() const;
