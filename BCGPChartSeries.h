...
public:
	...
	BOOL IsEmpty() const
	{
		...
		{
			const CBCGPChartValue& val = m_arData[i];
			if (!val.IsEmpty())
			{
				return FALSE;
			}
...
public:
	...
	AxisIndex GetRelatedAxisIndex(CBCGPChartAxis* pAxis);
...
public:
	...
	void EnableDataPointsSorting(BOOL bIsDataPointsSortEnabled = TRUE);
	BOOL IsDataPointsSortingEnabled() const {return m_bIsDataPointsSortEnabled;}

	void SetDataPointsOrder(DataPointsOrder DPOrder);
	DataPointsOrder GetDataPointsOrder() const {return m_DataPointsOrder;}
...
protected:
	...
	BOOL		m_bIsDataPointsSortEnabled;
	DataPointsOrder	m_DataPointsOrder;
...
public:
	...
	CBCGPChartBoxPlotData GetBoxPlotDataAt(int nDataPointIndex) const;
