...
#define BCGP_CHART_THUMBNAIL_DRAW_AXIS_NAME	0x0002
#define BCGP_CHART_THUMBNAIL_DRAW_TITLE		0x0004
...
public:
	...
	void SetLegendOrder(LegendOrder order) {m_LegendOrder = order;}
	LegendOrder GetLegendOrder() const {return m_LegendOrder;}
...
// Helpers for chart layout and some visual settings
	...
	virtual void ShowAxis(int nAxisID, BOOL bShow = TRUE, BOOL bForceShow = FALSE);
	...
	void SetTernaryAxesLabelMode(CBCGPChartTernaryAxis::LabelMode lm, BOOL bRedraw = FALSE);
	void SetTernaryAxesTitleMode(CBCGPChartTernaryAxis::TitleMode tm, BOOL bRedraw = FALSE);
...
// Current draw order
	...
	CBCGPSurfaceChart3DImpl* FindSurfaceChart3DImpl();
...
// Axes
	...
	virtual BOOL BeginResizeAxis(int nAxisID, BOOL bTop, const CBCGPPoint& ptStart);
	virtual void EndResizeAxis(BOOL bResizeCanceled = FALSE);
...
// Series Management
	...
	virtual void CleanUpChartData (int nSeries = -1, BOOL bRemoveUnusedEntries = FALSE);
...
protected:
	...
	virtual BOOL IsSeriesReversedOrder();
	virtual BOOL IsLegendReversedOrder();
...
#define SetTernaryAxasLabelMode SetTernaryAxesLabelMode
