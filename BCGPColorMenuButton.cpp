...
//*****************************************************************************************
void CBCGPColorMenuButton::SetWebColors()
{
			...
			BOOL bDrawBorder, BOOL bGrayDisabledButtons)
{
	...
	if (!OnDrawPaletteColorBox(pDC, rectColor, color, m_bIsAutomaticButton, TRUE, FALSE))
	{
...
//************************************************************************************
CBCGPColorBar* CBCGPColorMenuButton::CreateTearOffColorBar(CBCGPColorBar& src)
{
	return new CBCGPColorBar(src, m_nID);
}
//************************************************************************************
