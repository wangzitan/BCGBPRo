...
public:
	enum BCGP_FRAME_SIDE
	{
		BCGP_FRAME_SIDE_LEFT   = 0x01,
		BCGP_FRAME_SIDE_RIGHT  = 0x02,
		BCGP_FRAME_SIDE_TOP    = 0x04,
		BCGP_FRAME_SIDE_BOTTOM = 0x08,
		BCGP_FRAME_SIDE_ALL    = BCGP_FRAME_SIDE_LEFT | BCGP_FRAME_SIDE_RIGHT | BCGP_FRAME_SIDE_TOP | BCGP_FRAME_SIDE_BOTTOM
	};
...
public:
	...
	DWORD GetFrameSides() const
	{
		return m_dwFrameSides;
	}
	void SetFrameSides(DWORD dwFrameSides)
	{
		m_dwFrameSides = dwFrameSides & BCGP_FRAME_SIDE_ALL;
	}
