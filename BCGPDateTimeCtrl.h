...
public:
	...
	int m_monthFormat;	// 0 - short, 1 - long, 2 - numeric, -1 - system (based on the short date format)
...
public:
	...
	void EnableCalendarTodayButton(BOOL bEnable = TRUE)
	{
		m_bIsCalendarTodayButton = bEnable;
	}

	BOOL IsCalendarTodayButtonEnabled() const
	{
		return m_bIsCalendarTodayButton;
	}
...
protected:
	...
	virtual void ClosePopupCalendar (COleDateTime date = COleDateTime ());
