...
// Color darkness/luminosity:
	static BYTE GetColorBrightness (COLORREF clr);
	...
	static COLORREF ColorInvert(COLORREF clr);
	static COLORREF GetInterlaceColor(COLORREF clr);
	static COLORREF GetContrastColor(COLORREF clrBackground, COLORREF clrText = (COLORREF)-1);
