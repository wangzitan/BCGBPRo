...
public:
	...
	void SetVerticalAlignment(int nAlignment);	// TA_TOP, TA_CENTER or TA_BOTTOM, single line only
...
#if (!defined _BCGSUITE_) && (!defined _BCGSUITE_INC_)
	void SetSimplifiedBrowseIcon(BOOL bSet = TRUE);
	BOOL IsSimplifiedBrowseIcon() const
	{
		return m_bSimplifiedBrowseIcon;
	}
#endif
...
#if (!defined _BCGSUITE_) && (!defined _BCGSUITE_INC_)
	CBCGPToolBarImages	m_ImageBrowseSimplified;
	CBCGPToolBarImages	m_ImageBrowseSimplifiedHot;
#endif
...
#if (!defined _BCGSUITE_) && (!defined _BCGSUITE_INC_)
	CBCGPToolBarImages	m_ImageClearSimplified;
	CBCGPToolBarImages	m_ImageClearSimplifiedHot;
#endif
	BOOL				m_bTextIsEmpty;
	CToolTipCtrl*		m_pToolTip;
	BOOL				m_bShowToolTip;
	CString				m_strBrowseButtonToolTip;
	CString				m_strBrowseButtonDescr;
...
public:
	...
	void SetBrowseButtonToolTip(LPCTSTR lpszToolTip, LPCTSTR lpszDescription = NULL);
...
#if (!defined _BCGSUITE_) && (!defined _BCGSUITE_INC_)
	BOOL GetSimplifiedIconColors(COLORREF& clrSimple, COLORREF& clrHot, COLORREF& clrBase, BOOL bIsCloseButton);
	void PrepareSimplifiedIcons(BOOL bAlwaysRebuild);
#endif

	void PrepareClearIcon(BOOL bAlwaysRebuild);
	void DoFillBackground(CDC* pDC, const CRect& rect);
};
