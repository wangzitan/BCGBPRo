...
#endif
	m_wndColor2.SetColumnsNumber(BCGP_COLOR_COLUMNS);
	m_wndColor2.EnableAutomaticButton(m_Options.m_strEmptyColorLabel, 0xFFFFFFFF);

	CBCGPColor c2 = m_brush.GetGradientColor();
	m_wndColor2.SetColor(c2.a == 0. ? (COLORREF)-1 : (COLORREF)c2);

#ifndef _BCGSUITE_
	m_wndButtonSwap.SetImageAutoScale();
	m_wndButtonSwap.SetImage(globalData.Is32BitIcons () ? IDB_BCGBARRES_SWAP32 : IDB_BCGBARRES_SWAP);
#else
