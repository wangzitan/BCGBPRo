...
void CBCGPEditListBase::DoPaint(CDC* pDC)
{
	...
	{
		globalUtils.RemoveSingleAmp(strCaption, FALSE);
	}
...
//**************************************************************************
LRESULT CBCGPEditListBase::OnBCGOnChangeUnderline(WPARAM wp, LPARAM lp)
{
...
//*************************************************************************************
void CBCGPEditListBox::RemoveAllItems()
{
	if (GetSafeHwnd () == NULL || m_pWndList->GetSafeHwnd() == NULL)
	{
		ASSERT (FALSE);
		return;
	}
