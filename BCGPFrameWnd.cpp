...
{
	if (m_Impl.m_pLightBoxDlg != NULL && !m_Impl.m_pLightBoxDlg->CanBeClosed())
	{
		return;
	}
...
//****************************************************************************************
void CBCGPFrameWnd::EnableFloatingBarsMenuButton(BOOL bEnable)
{
	m_dockManager.EnableFloatingBarsMenuButton(bEnable);
}
//****************************************************************************************
BOOL CBCGPFrameWnd::AreFloatingBarsHaveMenuButton() const
{
...
//****************************************************************************************
LRESULT CBCGPFrameWnd::OnEnterSizeMove(WPARAM, LPARAM)
{
...
//*******************************************************************************************
void CBCGPFrameWnd::OnStyleChanging(int nStyleType, LPSTYLESTRUCT lpStyleStruct)
{
	BOOL bChanged = m_Impl.OnStyleChanging(nStyleType, lpStyleStruct);

	CFrameWnd::OnStyleChanging(nStyleType, lpStyleStruct);
...
//*****************************************************************************************
void CBCGPFrameWnd::OnSettingChange(UINT uFlags, LPCTSTR lpszSection) 
{
	CFrameWnd::OnSettingChange(uFlags, lpszSection);
	globalData.CheckForImmersiveColorSetChange(lpszSection);
}
//*****************************************************************************************
void CBCGPFrameWnd::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
