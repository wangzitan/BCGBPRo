...
protected:
	...
	BOOL GetLevelBarShape(CBCGPComplexGeometry& shape, double dblWidth, double dblOffsetFromFrame, int nScale, CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_STYLE style);

	CBCGPSize GetTextLabelMaxSize(CBCGPGraphicsManager* pGM);
	CBCGPSize GetLevelBarsPadding();

	double GetDefaultBarSize(CBCGPGaugeScaleObject* pScale);
...
protected:
	...
	CBCGPSize				m_szLevelBarsPadding;
};
