...
public:
	...
	virtual BOOL IsItemRadioStyle(int /*nIndex*/) const
	{
		return FALSE;
	}

	void SetColorBarWidth(int nWidth);
	virtual int GetColorBarWidth() const;

	void SetItemIndent(int nIndex, int nIndent, BOOL bRedraw = TRUE);
...
public:
	...
	int GetAccType(long lVal) const;
	int GetListIndexByChildID(long lVal, int* pAccType = NULL) const;
...
protected:
	...
	CBCGPToolBarImages	m_ImageListDisabled;
...
public:
	...
	void SetItemRadioStyle(int nIndex, BOOL bSet = TRUE, BOOL bRedraw = TRUE);
	virtual BOOL IsItemRadioStyle(int nIndex) const;
...
public:
	virtual HRESULT get_accRole(VARIANT varChild, VARIANT *pvarRole);
    virtual HRESULT get_accState(VARIANT varChild, VARIANT *pvarRole);
    virtual HRESULT get_accDefaultAction(VARIANT varChild, BSTR *pszDefaultAction);
    virtual HRESULT accDoDefaultAction(VARIANT varChild);
	virtual HRESULT get_accChildCount(long *pcountChildren);
	virtual HRESULT get_accChild(VARIANT varChild, IDispatch **ppdispChild);
