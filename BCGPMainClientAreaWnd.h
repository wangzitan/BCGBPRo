...
public:
	...
	CBCGPTabWnd::TabsDocumentsMenuStyle	m_DocumentMenuStyle;
	...
	BOOL								m_bFullSizeButtons;
	BOOL								m_bCloseTabOnMiddleClick;
};
...
protected:
	...
	afx_msg LRESULT OnMDIWindowCommand(WPARAM, LPARAM);
	DECLARE_MESSAGE_MAP()
