...
// Attributes
	...
	{
		return m_bMode2003 || m_bMode2013;
	}
	
	void SetMode2013 (BOOL bMode2013 = TRUE);
	BOOL IsMode2013 () const
	{
		return m_bMode2013;
	}
	...
	{
		return IsMode2003() ? TRUE : CBCGPBaseTabbedBar::CanSetCaptionTextToTabName ();
	}
	...
	virtual BOOL IsRestoreTabNames() const
	{
		return !IsMode2003();
	}
