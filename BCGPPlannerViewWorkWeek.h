...
private:
	virtual BOOL IsFullWeek() const
	{
		return FALSE;
	}
};

class BCGCBPRODLLEXPORT CBCGPPlannerViewWeekDays : public CBCGPPlannerViewWorkWeek  
{
	friend class CBCGPPlannerManagerCtrl;

	DECLARE_DYNCREATE(CBCGPPlannerViewWeekDays)

public:
	virtual ~CBCGPPlannerViewWeekDays();
