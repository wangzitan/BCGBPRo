...
public:
	...
	static void SetUseAppMainWndInNotifyParentDlg(BOOL bSet = TRUE)
	{
		m_bUseAppMainWndInNotifyParentDlg = bSet;
	}

	static BOOL IsUseAppMainWndInNotifyParentDlg()
	{
		return m_bUseAppMainWndInNotifyParentDlg;
	}
   ...
   virtual BOOL InCommand ()
   {
	...
	virtual BOOL IsRibbonAutohidePopup() const
	{
		return FALSE;
	}
...
protected:
	...
	static BOOL				m_bUseAppMainWndInNotifyParentDlg;

	int						m_nLastCommandID;
	
	BOOL					m_bNormalizeLocationInScreen;
