...
// Overrides
	...
	{
		return bcgp_max(m_nCurrTextHeight, CBCGPToolBar::GetRowHeight());
	}
	...
	virtual BOOL IsStopMouseClickAfterCloseActiveMenu() const	{	return FALSE; }
...
protected:
	...
	virtual CSize GetPopupMenuImageSize() const;
