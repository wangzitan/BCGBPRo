...
class BCGCBPRODLLEXPORT CBCGPColorPickerCtrl : public CButton
{
	DECLARE_DYNAMIC(CBCGPColorPickerCtrl)

// Construction
public:
	CBCGPColorPickerCtrl();
	virtual ~CBCGPColorPickerCtrl();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CBCGPColorPickerCtrl)
	protected:
