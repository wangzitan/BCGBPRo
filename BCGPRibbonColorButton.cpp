													...
													BOOL bDrawBorder)
{
	...
	m_strAutomaticButtonToolTip = (lpszToolTip == NULL) ? m_strAutomaticButtonLabel : CString(lpszToolTip);
...
void CBCGPRibbonColorButton::EnableOtherButton (LPCTSTR lpszLabel, LPCTSTR lpszToolTip)
{
	...
	m_strOtherButtonToolTip = (lpszToolTip == NULL) ? m_strOtherButtonLabel : CString(lpszToolTip);
...
//***************************************************************************
void CBCGPRibbonColorButton::SetWebColors()
{
	SetColors(CBCGPColor::GetRGBArray());
	SetColumns(BCGP_COLOR_COLUMNS);
}
//***************************************************************************
