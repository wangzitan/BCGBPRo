...
public:
	...
	BOOL LoadFromBuffer(LPCTSTR lpszXMLBuffer, CBCGPRibbonBar* pRibbonBar = NULL);
...
// Attributes:
public:
	CArray<CBCGPRibbonCustomPanel*, CBCGPRibbonCustomPanel*>& GetPanels() { return m_arPanels; };
...
// Attributes:
public:
	CArray<CBCGPRibbonCustomElement*, CBCGPRibbonCustomElement*>& GetElements() { return m_arElements; }
