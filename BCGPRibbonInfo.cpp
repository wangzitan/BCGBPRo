...
static LPCTSTR s_szTag_TextScenic             = _T("TEXT_SCENIC");
...
BOOL CBCGPBaseRibbonInfo::XElementButtonMain::FromTag (const CString& strTag)
{
	...
	tm.ReadEntityString (s_szTag_TextScenic, m_strTextScenic);
...
void CBCGPBaseRibbonInfo::XElementButtonMain::ToTag (CString& strTag) const
{
	...
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteEntityString (s_szTag_TextScenic, m_strTextScenic));
	...
	: CBCGPBaseRibbonInfo(c_dwVersion, e_UseRibbon | e_UseStatus)
{
	...
	m_sizeImage[e_ImagesMB]      = CSize(27, 27);
