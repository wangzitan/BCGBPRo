...
class BCGCBPRODLLEXPORT CBCGPRibbonDefaultPanelButton : public CBCGPRibbonButton
{
	...
	{
		return m_rect.IsRectEmpty () ? CString() : m_strText;
	}
...
public:
	...
	void EnableItemsCompacting(BOOL bEnable = TRUE);
	BOOL AreItemsCanBeCompacted() const
	{
		return m_bItemsCanBeCompacted;
	}
...
protected:
	...
	void SetParentMenuBar(CBCGPRibbonPanelMenuBar* pMenuBar);
	void DestroyControls();
	void SetAutohidePopupMode(BOOL bSet);
