...
public:
	...
	CBCGPRibbonPanelMenuBar(CBCGPRibbonBar* pRibbonBar);	// Auto-hide mode
...
protected:
	...
	virtual BOOL IsStopMouseClickAfterCloseActiveMenu() const;
...
public:
	...
	{
		return m_wndRibbonBar.IsRibbonPopupMode();
	}
