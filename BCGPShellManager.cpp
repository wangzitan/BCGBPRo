...
//****************************************************************************************
void CBCGPShellManager::InitShellAPIMethods()
{
	if (m_hinstShell32 != NULL)
	{
		return;
	...
	m_pfILFindLastID = (BCGP_ILFINDLASTID)::GetProcAddress (m_hinstShell32, "ILFindLastID");
}
//****************************************************************************************
...
//****************************************************************************************
LPITEMIDLIST CBCGPShellManager::CopyItem (LPCITEMIDLIST pidlSource, BOOL bFindLastID)
{
	ASSERT (m_pBCGMalloc != NULL);
	...
	if (bFindLastID)
	{
		...
		if (m_pfILFindLastID == NULL)
		{
			ASSERT(FALSE);
			return NULL;
		}

		pidlSource = (*m_pfILFindLastID)(pidlSource);
	}
