...
typedef LPCITEMIDLIST (__stdcall * BCGP_ILFINDLASTID)(LPCITEMIDLIST pidl);
...
public:
	...
	LPITEMIDLIST CopyItem (LPCITEMIDLIST pidlSource, BOOL bFindLastID = FALSE);
...
protected:
	...
	BCGP_ILFINDLASTID	m_pfILFindLastID;
};
