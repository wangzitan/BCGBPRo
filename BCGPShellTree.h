...
public:
	...
	BOOL RenameItem(HTREEITEM hItem, const CString& strName);
	
	HTREEITEM FindVisibleItem(LPCITEMIDLIST lpidl, HTREEITEM hStart = NULL);
...
protected:
	...
	HTREEITEM InsertShellItem(HTREEITEM hParentItem, LPSHELLFOLDER pParentFolder, LPITEMIDLIST pidlParent, LPITEMIDLIST pidlNew, BOOL bConcatenateItem = TRUE);
	HTREEITEM AddExistingFolder(HTREEITEM hParentItem, const CString& strPath);
