...
CBCGPSpinButtonCtrl::CBCGPSpinButtonCtrl()
{
	...
	m_bAutoVisualManagerStyle = FALSE;
	m_bOnGlass = FALSE;
...
void CBCGPSpinButtonCtrl::OnDraw (CDC* pDC)
{
	...
	if (GetBuddy ()->GetSafeHwnd () != NULL && (m_bOnGlass || CBCGPToolBarImages::m_bIsDrawOnGlass || m_bAutoVisualManagerStyle))
	{
		...
		{
			visualManager->OnDrawControlBorder(pDC, rectBorder, this, CBCGPToolBarImages::m_bIsDrawOnGlass || m_bOnGlass);
		}
	}
	...
	visualManager->OnDrawSpinButtons(pDC, rectClient, nState, (GetStyle() & UDS_HORZ) == UDS_HORZ, this);
}
//*****************************************************************************************
...
{
	m_bAutoVisualManagerStyle = m_bVisualManagerStyle = (BOOL) wp;
	return 0;
}
//**************************************************************************
