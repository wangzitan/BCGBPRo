...
public:	
	...
	LPCTSTR		lpszDescr;		// pane tooltip's description
...
public: 
	...
	CString GetTipDescription(int nIndex) const;
	void SetTipDescription(int nIndex, LPCTSTR pszTipDescr);
	...
	void SetPaneAnimation (int nIndex, HIMAGELIST hImageList, 
							UINT nFrameRate = 500 /* ms */, BOOL bUpdate = TRUE, BOOL bAlphaBlend = FALSE);
