...
CBCGPSwitchColors::CBCGPSwitchColors(BOOL bIsVisualManagerTheme/* = FALSE*/, BOOL bIsVertical/* = FALSE*/, BOOL bIsGDICtrl/* = FALSE*/)
{
	m_bIsVisualManagerTheme = bIsVisualManagerTheme;
	m_bIsGDICtrl = bIsGDICtrl;

	if (m_bIsVisualManagerTheme)
	{
		CBCGPVisualManager::GetInstance()->GetSwitchColors(*this, bIsVertical);
	}
	else
	{
...
//*******************************************************************************
void CBCGPSwitchImpl::SetVisualManagerTheme(BOOL bSet /*= TRUE*/, BOOL bRedraw /*= FALSE*/)
{
	SetColors(CBCGPSwitchColors(bSet, m_rect.Width() < m_rect.Height()), bRedraw);	
}
//*******************************************************************************
