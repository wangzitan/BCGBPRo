...
{
	CBCGPSwitchColors(BOOL bIsVisualManagerTheme = FALSE, BOOL bIsVertical = FALSE, BOOL bIsGDICtrl = FALSE);
...
public:
	...
	void SetVisualManagerTheme(BOOL bSet = TRUE, BOOL bRedraw = FALSE);

	BOOL IsVisualManagerTheme() const
	{
		return m_Colors.IsVisualManagerTheme();
	}
...
protected:
	...
	virtual void OnChangeVisualManager()
	{
		...
		{
			SetColors(CBCGPSwitchColors(TRUE), TRUE);
			Redraw();
		}
	}
