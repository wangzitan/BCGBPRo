...
// Operations
public:
	BOOL SetIconsList (UINT uiImageListResID, int cx, COLORREF clrTransparent = RGB (255, 0, 255), BOOL bAutoScale = FALSE, int cy = 0);
...
protected:
	...
	void SetScrollSizes ();
	virtual void AdjustScroll (BOOL bReposTasks = TRUE, BOOL bRedraw = TRUE);
	void RebuildMenu ();
