...
public:
	...
	void SetUseToolBarImagesInDropDownMenus(BOOL bSet = TRUE);
	BOOL IsToolBarImagesInDropDownMenus() const
	{
		return m_bToolBarImagesInDropDownMenus;
	}
	...
	static void SetNonPermittedCommands (CList<UINT, UINT>& lstCommands, BOOL bUpdateExistingToolBars = FALSE);
	...
	virtual int GetRowHeight () const
	{
		...
		return bcgp_max (globalData.GetTextHeight (m_dwStyle & CBRS_ORIENT_HORZ),
			(m_bMenuMode ?
			(m_sizeMenuButton.cy > 0 && !m_bToolBarImagesInDropDownMenus ?
	...
	{
		return m_bMenuMode ?
			(m_sizeMenuButton.cx > 0 && !m_bToolBarImagesInDropDownMenus ?
	...
	CSize GetImageSize () const
	{
		...
		{
			return m_bLocked ? m_sizeImageLocked : m_sizeImage;
		}
...
public: 
	...
	void HideEmptyMenus(BOOL bHide = TRUE)
	{
		m_bHideEmptyMenu = bHide;
	}

	BOOL IsHideEmptyMenus() const
	{
		return m_bHideEmptyMenu;
	}
...
protected:
	...
	static BOOL					m_bUpdateUnpermittedCommands;
	...
	BOOL				m_bIsLocal;
	BOOL				m_bToolBarImagesInDropDownMenus;
	BOOL				m_bHideEmptyMenu;
