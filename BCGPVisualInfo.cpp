...
static LPCTSTR s_szTag_ValueFormat            = _T("VALUE_FORMAT");
...
static LPCTSTR s_szTag_LevelBars              = _T("LEVELBARS");
static LPCTSTR s_szTag_LevelBar               = _T("LEVELBAR");
...
static LPCTSTR s_szTag_LevelValue             = _T("LEVEL_VALUE");
static LPCTSTR s_szTag_LevelBarStyle          = _T("STYLE");
...
static LPCTSTR s_szTag_Value_Brush            = _T("VALUE_BRUSH");
static LPCTSTR s_szTag_Label_Brush            = _T("LABEL_BRUSH");
static LPCTSTR s_szTag_ProgressFill_Brush     = _T("PROGRESS_FILL_BRUSH");
static LPCTSTR s_szTag_ProgressOutline_Brush  = _T("PROGRESS_OUTLINE_BRUSH");
static LPCTSTR s_szTag_ProgressFillGradient_Brush = _T("PROGRESS_FILL_GRADIENT_BRUSH");
static LPCTSTR s_szTag_ProgressOutlineGradient_Brush = _T("PROGRESS_OUTLINE_GRADIENT_BRUSH");
static LPCTSTR s_szTag_ProgressFillNonComplete_Brush = _T("PROGRESS_FILL_NONCOMPLETE_BRUSH");
static LPCTSTR s_szTag_ProgressOutlineNonComplete_Brush = _T("PROGRESS_OUTLINE_NONCOMPLETE_BRUSH");
...
static LPCTSTR s_szTag_EquidistantLabels      = _T("EQUIDISTANT_LABELS");
...
static LPCTSTR s_szTag_TextFormatAutoSize     = _T("TEXTFORMAT_AUTOSIZE");
...
static LPCTSTR s_szTag_Marquee                = _T("MARQUEE");
static LPCTSTR s_szTag_FadeColor              = _T("FADE_COLOR");
static LPCTSTR s_szTag_FadeSize               = _T("FADE_SIZE");
static LPCTSTR s_szTag_Clockwise              = _T("CLOCKWISE");
...
LPCTSTR CBCGPVisualInfo::s_szCircularProgressInd   = _T("CircularProgressIndicator");
...
CBCGPVisualInfo::XGaugeElement* CBCGPVisualInfo::XGaugeElement::CreateFromName (const CString& name)
{
	...
	else if (name.Compare (CBCGPVisualInfo::s_szCircularProgressInd) == 0)
	{
		element = new CBCGPVisualInfo::XElementCircularProgress;
	}
...
CBCGPVisualInfo::XGaugeLevelBar::XGaugeLevelBar()
	: m_nScale            (0)
	, m_dblValue          (0.0)
	, m_dblWidth          (0.0)
	, m_dblOffsetFromFrame(0.0)
	, m_Style             (CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_RECT)
{
}
...
BOOL CBCGPVisualInfo::XGaugeLevelBar::FromTag (const CString& strTag)
{
	CBCGPTagManager tm (strTag);

	tm.ReadInt (s_szTag_Scale_Id, m_nScale);
	tm.ReadDouble (s_szTag_LevelValue, m_dblValue);
	tm.ReadDouble (s_szTag_Width, m_dblWidth);
	tm.ReadDouble (s_szTag_Offset_Frame, m_dblOffsetFromFrame);

	int style = CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_RECT;
	tm.ReadInt (s_szTag_LevelBarStyle, style);
	m_Style = (CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_STYLE)bcg_clamp(style, 
		CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_STYLE_FIRST, CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_STYLE_LAST);
	
 	tm.ReadBrush (s_szTag_Fill_Brush, m_brFill);
 	tm.ReadBrush (s_szTag_Fill_Outline, m_brOutline);
	tm.ReadBrush (s_szTag_Value_Brush, m_brValue);

	return TRUE;
}

void CBCGPVisualInfo::XGaugeLevelBar::ToTag (CString& strTag) const
{
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteInt (s_szTag_Scale_Id, m_nScale, m_nScale + 1));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_LevelValue, m_dblValue, 0.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_Width, m_dblWidth, 0.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_Offset_Frame, m_dblOffsetFromFrame, 0.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteInt (s_szTag_LevelBarStyle, (int)m_Style, CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_RECT));
 	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Fill_Brush, m_brFill));
 	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Fill_Outline, m_brOutline));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Value_Brush, m_brValue));
}
...
CBCGPVisualInfo::XGaugeElement::~XGaugeElement()
{
	...
	for (i = 0; i < (int)m_arLevelBars.GetSize (); i++)
	{
		if (m_arLevelBars[i] != NULL)
		{
			delete m_arLevelBars[i];
		}
	}
...
BOOL CBCGPVisualInfo::XCircularScale::FromTag (const CString& strTag)
{
	...
	tm.ReadBool (s_szTag_EquidistantLabels, m_bEquidistantLabels);
...
void CBCGPVisualInfo::XCircularScale::ToTag (CString& strTag) const
{
	...
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBool (s_szTag_EquidistantLabels, m_bEquidistantLabels, FALSE));
}
...
CBCGPVisualInfo::XElementCircularProgress::XElementCircularProgress()
	: CBCGPVisualInfo::XElementCircular (CBCGPVisualInfo::s_szCircularProgressInd)
	, m_ProgressColors()
	, m_Options       ()
	, m_dblStartValue (0.0)
	, m_dblFinishValue(100.0)
	, m_dblStep       (0.0)
	, m_dblValue      (0.0)
{
}
...
BOOL CBCGPVisualInfo::XElementCircular::FromTag (const CString& strTag)
{
	...
	if (tm.ExcludeTag (s_szTag_Elements, strElements))
	{
		...
		while (tmElements.ExcludeTag (s_szTag_Element, strElement))
		{
			...
			{
				CBCGPTagManager tm1 (strElement);
				tm1.ReadString (CBCGPBaseInfo::s_szTag_ElementName, strElementName);
			}
	...
	CString strLevelBars;
	if (tm.ExcludeTag (s_szTag_LevelBars, strLevelBars))
	{
		CBCGPTagManager tmLevelBars (strLevelBars);

		CString strLevelBar;
		while (tmLevelBars.ExcludeTag (s_szTag_LevelBar, strLevelBar))
		{
			XGaugeLevelBar* pLevelBar = new XGaugeLevelBar;
			if (pLevelBar->FromTag (strLevelBar))
			{
...
void CBCGPVisualInfo::XElementCircular::ToTag (CString& strTag) const
{
	...
	{
		CString strLevelBar;
		m_arLevelBars[i]->ToTag (strLevelBar);
		CBCGPTagManager::WriteItem (strLevelBars, s_szTag_LevelBar, strLevelBar, TRUE);
	}
	CBCGPTagManager::WriteItem (strTag, s_szTag_LevelBars, strLevelBars);
...
BOOL CBCGPVisualInfo::XElementCircularProgress::FromTag (const CString& strTag)
{
	if (!XGaugeElement::FromTag(strTag))
	{
		return FALSE;
	}
	...
	tm.ReadBool(s_szTag_Marquee, m_Options.m_bMarqueeStyle);
	tm.ReadDouble(s_szTag_Width, m_Options.m_dblProgressWidth);

	int shape = (int)CBCGPCircularProgressIndicatorOptions::BCGPCircularProgressIndicator_Arc;
	tm.ReadInt (s_szTag_Shape_Type, shape);
	m_Options.m_Shape = (CBCGPCircularProgressIndicatorOptions::Shape)bcg_clamp(shape, (int)CBCGPCircularProgressIndicatorOptions::BCGPCircularProgressIndicator_First, (int)CBCGPCircularProgressIndicatorOptions::BCGPCircularProgressIndicator_Last);

	tm.ReadBool(s_szTag_FadeColor, m_Options.m_bFadeColor);
	tm.ReadBool(s_szTag_FadeSize, m_Options.m_bFadeSize);
	tm.ReadBool(s_szTag_Clockwise, m_Options.m_bClockwiseRotation);
	tm.ReadEntityString (s_szTag_ValueFormat, m_Options.m_strPercentageFormat);

	tm.ReadDouble (s_szTag_Start_Value, m_dblStartValue);
	tm.ReadDouble (s_szTag_Finish_Value, m_dblFinishValue);
	tm.ReadDouble (s_szTag_Step, m_dblStep);
	tm.ReadDouble (s_szTag_DataValue, m_dblValue);
	tm.ReadEntityString (s_szTag_TextValue, m_strLabel);

	return TRUE;
}

void CBCGPVisualInfo::XElementCircularProgress::ToTag (CString& strTag) const
{
	XGaugeElement::ToTag(strTag);

	CBCGPCircularProgressIndicatorOptions options;

	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBool(s_szTag_Marquee, m_Options.m_bMarqueeStyle, options.m_bMarqueeStyle));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble(s_szTag_Width, m_Options.m_dblProgressWidth, options.m_dblProgressWidth));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteInt (s_szTag_Shape_Type, (int)m_Options.m_Shape, (int)options.m_Shape));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBool(s_szTag_FadeColor, m_Options.m_bFadeColor, options.m_bFadeColor));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBool(s_szTag_FadeSize, m_Options.m_bFadeSize, options.m_bFadeSize));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBool(s_szTag_Clockwise, m_Options.m_bClockwiseRotation, options.m_bClockwiseRotation));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteEntityString (s_szTag_ValueFormat, m_Options.m_strPercentageFormat, options.m_strPercentageFormat, TRUE));

	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_Start_Value, m_dblStartValue, 0.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_Finish_Value, m_dblFinishValue, 100.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_Step, m_dblStep, 0.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteDouble (s_szTag_DataValue, m_dblValue, 0.0));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteEntityString (s_szTag_TextValue, m_strLabel));
}

BOOL CBCGPVisualInfo::XElementCircularProgress::ColorsFromTag (const CString& strTag)
{
	CBCGPTagManager tm (strTag);

	tm.ReadBrush (s_szTag_Fill_Brush, m_ProgressColors.m_brFill);
	tm.ReadBrush (s_szTag_Frame_Outline, m_ProgressColors.m_brFrameOutline);
	tm.ReadBrush (s_szTag_ProgressFill_Brush, m_ProgressColors.m_brProgressFill);
	tm.ReadBrush (s_szTag_ProgressOutline_Brush, m_ProgressColors.m_brProgressOutline);
	tm.ReadBrush (s_szTag_ProgressFillGradient_Brush, m_ProgressColors.m_brProgressFillGradient);
	tm.ReadBrush (s_szTag_ProgressOutlineGradient_Brush, m_ProgressColors.m_brProgressOutlineGradient);
	tm.ReadBrush (s_szTag_ProgressFillNonComplete_Brush, m_ProgressColors.m_brProgressFillNonComplete);
	tm.ReadBrush (s_szTag_ProgressOutlineNonComplete_Brush, m_ProgressColors.m_brProgressOutlineNonComplete);
	tm.ReadBrush (s_szTag_Value_Brush, m_ProgressColors.m_brProgressLabel);
	tm.ReadBrush (s_szTag_Label_Brush, m_ProgressColors.m_brTextLabel);

	return TRUE;
}

void CBCGPVisualInfo::XElementCircularProgress::ColorsToTag (CString& strTag) const
{
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Fill_Brush, m_ProgressColors.m_brFill));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Frame_Outline, m_ProgressColors.m_brFrameOutline));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_ProgressFill_Brush, m_ProgressColors.m_brProgressFill));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_ProgressOutline_Brush, m_ProgressColors.m_brProgressOutline));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_ProgressFillGradient_Brush, m_ProgressColors.m_brProgressFillGradient));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_ProgressOutlineGradient_Brush, m_ProgressColors.m_brProgressOutlineGradient));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_ProgressFillNonComplete_Brush, m_ProgressColors.m_brProgressFillNonComplete));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_ProgressOutlineNonComplete_Brush, m_ProgressColors.m_brProgressOutlineNonComplete));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Value_Brush, m_ProgressColors.m_brProgressLabel));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Label_Brush, m_ProgressColors.m_brTextLabel));
}
...
BOOL CBCGPVisualInfo::XElementNumeric::FromTag (const CString& strTag)
{
	...
	{
		tm.ReadTextFormat (s_szTag_TextFormat, m_fmtText);
		tm.ReadBool(s_szTag_TextFormatAutoSize, m_bTextFormatAutoSize);
	}
...
void CBCGPVisualInfo::XElementNumeric::ToTag (CString& strTag) const
{
	...
	{
		CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteTextFormat (s_szTag_TextFormat, m_fmtText));
		CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBool(s_szTag_TextFormatAutoSize, m_bTextFormatAutoSize, FALSE));
	}
}
