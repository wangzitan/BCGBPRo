...
public:
	...
	class XGaugeLevelBar
	{
	public:
		XGaugeLevelBar ();
		virtual ~XGaugeLevelBar ();
	...
	public:
		...
		double		m_dblWidth;
		double		m_dblOffsetFromFrame;
		CBCGPGaugeLevelBarObject::BCGP_GAUGE_LEVEL_OBJECT_STYLE
					m_Style;
		CBCGPBrush	m_brFill;
		CBCGPBrush	m_brOutline;
		CBCGPBrush	m_brValue;
	};
	typedef CArray<XGaugeLevelBar*, XGaugeLevelBar*> XArrayGaugeLevelBar;
	...
	public:
		...
		XArrayGaugeLevelBar		m_arLevelBars;
	...
	class XElementCircularProgress: public XElementCircular
	{
	public:
		XElementCircularProgress ();
		virtual ~XElementCircularProgress ();
...
public:
	...
	static LPCTSTR s_szCircularProgressInd;
