...
// Construction
public:
	CBCGPWindowsManagerDlg(CBCGPMDIFrameWnd* pMDIFrame, BOOL bHelpButton = FALSE, BOOL bResizable = FALSE);   // standard constructor
...
protected:
	...
	void			FillWindowList();
	void			AddMDIChildren(CBCGPMDIFrameWnd* pMDIFrame, CDC& dcList, int& cxExtent);
	void			SelActive();
	void			UpdateButtons();
