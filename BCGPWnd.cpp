...
////////////////////////////////////////////////////////////////////////////////
// CBCGPCtrlPlaceHolderHelper

BOOL CBCGPCtrlPlaceHolderHelper::CreateOnPlaceHolder(CWnd* pParent, UINT nIDPlaceHolder, UINT nID /*= 0*/, DWORD dwStyle /*= WS_TABSTOP | WS_CHILD | WS_VISIBLE*/, BOOL bDestroyPlaceHolder /*= FALSE*/, LPVOID lParam/* = NULL*/)
{
	...
	CWnd* pWndPlaceHolder = pParent->GetDlgItem(nIDPlaceHolder);
	...
	CRect rect;
	pWndPlaceHolder->GetWindowRect(rect);
	pParent->ScreenToClient(rect);
	
	CWnd* pCtrl = DoCreateOnPlaceHolder(pParent, nID, dwStyle, rect, lParam);
	...
	if ((pCtrl->GetStyle() & WS_TABSTOP) == WS_TABSTOP)
	{
		pCtrl->SetWindowPos(pWndPlaceHolder, 0, 0, 0, 0, SWP_NOACTIVATE | SWP_NOMOVE | SWP_NOSIZE);
	}
	
	if (bDestroyPlaceHolder)
	{
		pWndPlaceHolder->DestroyWindow();
	}
	else
	{
		pWndPlaceHolder->ShowWindow(SW_HIDE);
		pWndPlaceHolder->EnableWindow(FALSE);
	}
