...
class CBCGPImageEditDlg;

/////////////////////////////////////////////////////////////////////////////
// CImagePaintArea window

class BCGCBPRODLLEXPORT CImagePaintArea : public CButton
{
// Construction
public:
	CImagePaintArea(CBCGPImageEditDlg* pParentDlg);
...
protected:
	...
	HCURSOR				m_hcurColor;
	CSize				m_sizeCell;
	CBCGPImageEditDlg*	m_pParentDlg;
	CPen				m_penDraw;
	CPen				m_penStretch;
	CRect				m_rectDraw;
	BOOL				m_bMapToSysColor;
...
public:
	...
	void SetMapToSysColor(BOOL bMapToSysColor)
	{
		m_bMapToSysColor = bMapToSysColor;
	}
